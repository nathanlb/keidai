...
import { RUNS_PATH } from "../../shell/navigation.js";
  ...
  return (
    <Card className="overflow-hidden py-0 shadow-none">
      <CardContent className="flex h-full flex-col p-0">
        <div className="
          flex items-center gap-2 border-b border-border px-4 py-3.25
        ">
          <span
            className="size-1.75 shrink-0 rounded-full bg-chart-1"
            aria-hidden
          />
        ...
        {runs.map((run) => (
          <Link
            ...
            className="
              border-b border-border px-4 py-3.25 no-underline transition-colors
        ...
        <div className="mt-auto px-4 py-2.75 text-xs text-muted-foreground">
