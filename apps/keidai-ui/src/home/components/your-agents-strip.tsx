      ...
      ">
        {agents.map((agent) => (
          <Link
            ...
            className="
              rounded-xl border border-border bg-card px-3.75 py-3.5
          ...
          >
            <div className="flex items-center gap-2.5">
              <div className="
                ...
                bg-secondary font-mono text-[11.5px] font-bold
            ...
            <p className="mt-2.75 text-xs/normal text-muted-foreground">
              {agent.summary}
            </p>
