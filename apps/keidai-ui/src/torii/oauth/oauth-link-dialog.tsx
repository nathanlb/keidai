            ...
            <>
              <DialogHeader>
                ...
                <DialogDescription>
                  ...
                  {hasConfiguredScopes ? " with the configured scopes" : ""}.
                  Grant access for owner <Mono>{ownerId}</Mono>.
                </DialogDescription>
              </DialogHeader>
              ...
              {hasConfiguredScopes ? (
                ...
                <div className="mt-4 flex flex-col gap-1.5 rounded-lg border border-border px-3.5 py-3">
                  ...
                  <p className="text-[13px] leading-normal text-muted-foreground">
                    {providerLabel} does not declare scopes in{" "}
                    <Mono>torii.yaml</Mono>. Torii requests provider-default
                    access during authorization.
                  </p>
                </div>
              )}
            ...
            <>
              <div className="flex flex-col items-center px-1 pt-2 text-center">
                ...
                <p className="mt-1.5 max-w-[330px] text-[13px] leading-normal text-muted-foreground">
                  Finish authorization in the popup window. This dialog will
                  close automatically when Torii receives the callback at{" "}
          ...
          {step === "linked" ? (
            <>
              <div className="flex flex-col items-center px-1 pt-2 text-center">
                ...
                <p className="mt-1.5 max-w-[330px] text-[13px] leading-normal text-muted-foreground">
                  Torii stored the grant for owner <Mono>{ownerId}</Mono> and
                  will refresh it automatically. Calls needing {providerLabel}{" "}
                  will now resolve.
                </p>
              </div>
          ...
          {step === "error" ? (
            <>
              <div className="flex flex-col items-center px-1 pt-2 text-center">
                ...
                <p className="mt-1.5 max-w-[330px] text-[13px] leading-normal text-muted-foreground">
                  <Mono>{errorMessage ?? "access_denied"}</Mono> — the request
                  was cancelled, or the provider&apos;s{" "}
                  <Mono>redirect_uri</Mono> doesn&apos;t match the gateway. No
                  grant was stored.
                </p>
              </div>
